...
#include <misc/shub_driver.h> // SHMDS_HUB_1301_01 add
...
EXPORT_SYMBOL(shub_api_enable_pwm);
EXPORT_SYMBOL(shub_api_set_param_pwm);
EXPORT_SYMBOL(shub_api_get_param_pwm);
EXPORT_SYMBOL(shub_api_enable_bkl_pwm);
EXPORT_SYMBOL(shub_api_set_param_bkl_pwm);
EXPORT_SYMBOL(shub_api_get_param_bkl_pwm);
EXPORT_SYMBOL(shub_api_set_port_bkl_pwm);
EXPORT_SYMBOL(shub_api_get_port_bkl_pwm);

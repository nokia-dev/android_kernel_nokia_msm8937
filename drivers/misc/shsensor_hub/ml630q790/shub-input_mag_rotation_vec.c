...
int shub_rot_mag_init(void)          /* SHMDS_HUB_3701_01 mod */
{
    int ret;
...
void shub_rot_mag_exit(void)         /* SHMDS_HUB_3701_01 mod */
{
    platform_driver_unregister(&shub_rot_mag_driver);
}

// late_initcall(shub_rot_mag_init); /* SHMDS_HUB_3701_01 del */
// module_exit(shub_rot_mag_exit);   /* SHMDS_HUB_3701_01 del */

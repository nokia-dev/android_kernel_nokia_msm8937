...
static int32_t shub_probe_orien(struct platform_device *pfdev);
static int32_t shub_remove_orien(struct platform_device *pfdev);

#ifdef CONFIG_OF
    static struct of_device_id shub_of_match_tb_orien[] = {
        { .compatible = "sharp,shub_orien" ,},
        {}
    };
#else
    #define shub_of_match_tb_orien NULL
#endif
...
static struct platform_driver shub_orien_driver = {
    .probe = shub_probe_orien,
    .remove = shub_remove_orien,
    .shutdown = NULL,
    .driver = {
        .name = "shub_dev_orien",
        .of_match_table = shub_of_match_tb_orien,
    },
};

int shub_orien_init(void)          /* SHMDS_HUB_3701_01 mod */
{
    int ret;
    
    ret = platform_driver_register(&shub_orien_driver);

    return ret;
}

void shub_orien_exit(void)         /* SHMDS_HUB_3701_01 mod */
{
    platform_driver_unregister(&shub_orien_driver);
}

// late_initcall(shub_orien_init); /* SHMDS_HUB_3701_01 del */
// module_exit(shub_orien_exit);   /* SHMDS_HUB_3701_01 del */

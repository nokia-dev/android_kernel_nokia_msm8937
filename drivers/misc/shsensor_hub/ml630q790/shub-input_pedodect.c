...
int shub_pedodet_init(void)          /* SHMDS_HUB_3701_01 mod */
{
    int ret;
...
void shub_pedodet_exit(void)         /* SHMDS_HUB_3701_01 mod */
{
    platform_driver_unregister(&shub_pedodet_driver);
}

// late_initcall(shub_pedodet_init); /* SHMDS_HUB_3701_01 del */
// module_exit(shub_pedodet_exit);   /* SHMDS_HUB_3701_01 del */

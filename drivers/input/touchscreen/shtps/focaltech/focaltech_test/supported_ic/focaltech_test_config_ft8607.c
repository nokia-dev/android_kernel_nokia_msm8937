...
void OnInit_FT8607_TestItem(char *strIniFile)
{
    ...
    g_stCfg_FT8607_TestItem.OPEN_TEST = fts_atoi(str);

    /////////////////////////////////// CB_UNIFORMITY_TEST
//    GetPrivateProfileString("TestItem","CB_UNIFORMITY_TEST","1",str,strIniFile);
//    g_stCfg_FT8607_TestItem.CB_UNIFORMITY_TEST = fts_atoi(str);
...
//    g_stCfg_FT8607_TestItem.DIFFER2_UNIFORMITY_TEST = fts_atoi(str);
...
void OnInit_FT8607_BasicThreshold(char *strIniFile)
{
    ...
    //g_stCfg_FT8607_BasicThreshold.Project_Code.Format("%s", str);
...
//    g_stCfg_FT8607_BasicThreshold.bRawDataTest_VA_Check = fts_atoi(str);
...
//    g_stCfg_FT8607_BasicThreshold.bRawDataTest_VKey_Check = fts_atoi(str);
//    GetPrivateProfileString("Basic_Threshold","RawDataTest_Min_VKey","5000",str,strIniFile);
//    g_stCfg_FT8607_BasicThreshold.RawDataTest_Min_VKey = fts_atoi(str);
//    GetPrivateProfileString("Basic_Threshold","RawDataTest_Max_VKey","11000",str,strIniFile);
//    g_stCfg_FT8607_BasicThreshold.RawDataTest_Max_VKey = fts_atoi(str);
...
//    g_stCfg_FT8607_BasicThreshold.bCBTest_VKey_DCheck_Check = fts_atoi(str);
//    GetPrivateProfileString("Basic_Threshold","CBTest_Min_DCheck_Vkey","140",str,strIniFile);
//    g_stCfg_FT8607_BasicThreshold.CbTest_Min_DCheck_Vkey = fts_atoi(str);
//    GetPrivateProfileString("Basic_Threshold","CBTest_Max_DCheck_Vkey","180",str,strIniFile);
//    g_stCfg_FT8607_BasicThreshold.CbTest_Max_DCheck_Vkey = fts_atoi(str);
...
void SetTestItem_FT8607(void)
{
    ...
    //////////////////////////////////////////////////CB_UNIFORMITY_TEST
//    if ( g_stCfg_FT8607_TestItem.CB_UNIFORMITY_TEST == 1)
//    {
//        fts_SetTestItemCodeName(Code_FT8607_CB_UNIFORMITY_TEST);
//    }
    ...
    //////////////////////////////////////////////////OPEN_TEST
    if ( g_stCfg_FT8607_TestItem.OPEN_TEST == 1)
    {
        fts_SetTestItemCodeName(Code_FT8607_OPEN_TEST);
    }
    ...
    //////////////////////////////////////////////////DIFFER2_UNIFORMITY_TEST
//    if ( g_stCfg_FT8607_TestItem.DIFFER2_UNIFORMITY_TEST == 1)
//    {
//        fts_SetTestItemCodeName(Code_FT8607_DIFFER2_UNIFORMITY_TEST);
//    }

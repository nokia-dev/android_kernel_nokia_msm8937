...
#define ID_IOCTL_SUSPEND_RESUME             _IOW(FINGERPRINT_IOCTL, 90, int)
#define ID_IOCTL_TB_INT_FACTORY             _IOW(FINGERPRINT_IOCTL, 92, int)
#define ID_IOCTL_READ_TB_FACTORY_STATUS     _IOW(FINGERPRINT_IOCTL, 93, int)
#define ID_IOCTL_WRITE_TB_FACTORY_STATUS    _IOW(FINGERPRINT_IOCTL, 94, int)

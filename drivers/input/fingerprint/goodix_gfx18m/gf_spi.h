...
struct gf_key_map
{
    char *name;
    unsigned short val;
    unsigned short key_customer1;//HZ, Add for key define by customer
    unsigned short key_customer2;//HZ, Add for key define by customer
};
...
struct gf_dev {
	...
	int key_customer_define; //HZ, Add for key define by customer
};
